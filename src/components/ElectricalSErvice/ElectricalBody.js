        ...
        <div className="hero  !bg-no-repeat !bg-cover" style={{
            ...
            <div className='bg-[#000] bg-opacity-70 w-[100%] h-[100%]'>
                <div className='max-w-[800px] mx-auto text-white py-10 px-3'>
                    ...
                    <div>
                        <div className='text-2xl font-bold mt-5'><i className="fa-solid fa-circle-check text-[#ED8502] pr-3 "></i>Lighting Installation:</div> <div className='text-xl font-medium mb-4'> Upgrade your home's lighting with our professional installation services. We can install anything from ceiling fans to dimmer switches to help you save energy and enhance your home's ambiance.</div>

                        <div className='text-2xl font-bold mt-5'><i className="fa-solid fa-circle-check text-[#ED8502] pr-3 "></i>Circuit Breaker Repair:</div>
                        ...
                        <div className='text-2xl font-bold mt-5'><i className="fa-solid fa-circle-check text-[#ED8502] pr-3 "></i>Electrical Panel Upgrades:</div>
