...
const SolarBody = () => {
    return (
        <div className="hero h-screen !bg-no-repeat !bg-cover" style={{
            background: `url(https://i.ibb.co/vDcXnPD/bg13.png)`
        }}>
            <div className='bg-black bg-opacity-70 w-[100%] h-[100%]'>
                <div className='max-w-[800px] mx-auto text-white py-10 px-3'>
                    ...
                    <div>
                        <div className='text-2xl font-bold mt-5'><i className="fa-solid fa-circle-check text-[#ED8502] pr-3 "></i>Solar Panel Installation:</div> <div className='text-xl font-medium mb-4'> Reduce your energy bills and your carbon footprint with our solar panel installation services. We use high-quality panels that are designed to maximize your home's energy efficiency.
                        </div>

                        <div className='text-2xl font-bold mt-5'><i className="fa-solid fa-circle-check text-[#ED8502] pr-3 "></i>Solar Battery Backup:</div>
