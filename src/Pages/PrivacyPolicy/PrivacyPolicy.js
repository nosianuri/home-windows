                ...
                <div>
                    <div className=''>
                        <div className='max-w-7xl mx-auto sm:py-16 py-5'>
                            ...
                            <ul>
                                <li>Visit our website at <a className='underline text-[#ffae00]' href="https://mrhomeservice.net/window-installation">https://mrhomeservice.net/window-installation</a>, <a href="/"></a> or any website of ours that links to this privacy notice</li>
