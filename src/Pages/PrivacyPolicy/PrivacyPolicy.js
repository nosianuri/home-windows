                ...
                <div>
                    <div className='bg-[#003144] text-[#FFFFFF]'>
                        <div className='max-w-7xl mx-auto sm:py-16 py-5'>
                            ...
                            <ul>
                                <li>Visit our website at <a className='underline text-[#ffae00]' href="https://mrhomeservice.net/">https://mrhomeservice.net</a> or any website of ours that links to this privacy notice</li>
