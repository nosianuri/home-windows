                ...
                <div id='details'>
                    ...
                    <div id='cac-footer-legal'>
                        <div className='max-w-[990px] mx-auto'>
                            ...
                            <h3 className='text-xl mb-2 text-[#e48a03]'>Looking for a reliable pest professional? Look no further!</h3>
                            <p className='mb-5 text-[17px]'>Our skilled experts have the tools and expertise to effectively address your pest issue. Precise and focused solutions to effectively address specific pest issues, eliminating pests with accuracy and efficiency. Comprehensive approach to eliminate and prevent pest infestations, ensuring your entire property remains protect. Proactive measures to safeguard and prevent pest infestations before they occur, ensuring a pest-free environment. Our trusted and experienced professionals are dedicated to effectively and safely addressing your pest issues</p>
                            <h3 className='text-xl mb-2 text-[#e48a03]'>Top Pest Control In The United States Area</h3>
                            <p className='mb-5 text-[17px]'>Our team of professionals are fully equipped to offer you cost-effective, efficient, and hassle-free solutions. Ensuring that your pest problem becomes a thing of the past. We are dedicated to providing you with long-lasting results so that you won’t have to worry about your pest problem again. </p>
                            <h3 className='text-xl mb-2 text-[#e48a03]'>Get Accurate Quotes For Your Pest Control Project</h3>
                            <p className='mb-2 text-[17px]'>We'll find you up to all pest control pros who specialize in your project type - in less than 24 hours. That means you can compare pest control estimates side by side without having to call multiple pest control pros yourself.</p>
