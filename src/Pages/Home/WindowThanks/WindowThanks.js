...
const WindowThanks = () => {
    return (
        <>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Thanks | Window Installation</title>
            </Helmet>
            <div>
                    ...
                    <div className='max-w-7xl mx-auto'>
                        <div className='max-w-[700px] mx-auto text-center px-3'>
                            ...
                            <div className='max-w-[500px] mx-auto'>
                                <div>
                                    <h3 className='text-center font-medium sm:text-4xl text-2xl !leading-snug'>A Windows contractor will be reaching out very soon! </h3>
