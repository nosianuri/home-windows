    ...
    return (
        <div>
            <div className='max-w-7xl mx-auto'>
                <h3 className='font-extrabold text-[38px] text-[#98c83f]'>Upgrade Your Home with Confidence <br /> Choose Mr. Home Service for Expert Renovations!</h3>
                ...
                <div className='grid sm:grid-cols-3 grid-cols-1 gap-5 my-8'>
                    ...
                    <div className='text-center'>
                        <img src="https://i.ibb.co/XpNx5xM/honor-001.png
