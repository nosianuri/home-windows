        ...
        <div className='bg-[#f3f3f3]'>
            <footer className="footer px-10 pt-10 text-base-content mx-auto">
                ...
                <div>
                    ...
                    <a className="link link-hover">Terms & Service</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 pb-10   text-base-content  mx-auto">
                <div className="items-center ">
                    <div> <p className='text-sm text-center mt-8'>© 2023 Mr. Home Service, All Rights Reserved. <a className='underline hover:text-[#f6b234]' href="/privacy-policy">Privacy Policy</a> Cookie Policy <a className='underline hover:text-[#f6b234]' href="/terms">Terms & Condition</a></p></div>
