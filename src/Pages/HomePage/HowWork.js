  ...
  return (
    <div className='my-10'>
        <div className='text-center'>
            ...
            <p className='w-[800px] mx-auto text-[12px]'>See the plan contract for coverage details, including service fees, limitations and exclusions. Charges for non-covered items may apply. Offer expires April 30, 2023. Pricing available to new customers only. Discount cannot be applied to previous purchases or combined with other offers. Offer not valid in Alaska, New York City or Hawaii. Not valid in conjunction with a real estate transaction. Discount only available for single-family homes under 5,000 sq. ft. (includes condos and townhomes).</p>
        </div>
    </div>
  )
}
