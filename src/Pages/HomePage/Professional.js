...
const Professional = () => {
    ...
    const services = [
        ...
        },
        {
            id: 3,
            name: 'Pest Control',
            img: 'https://i.ibb.co/tK30mvV/pest-control-icon.png',
            link: '/pest-control',
            desc: 'We offer quick, safe, effective and responsive pest control solutions to protect you and your property from pest infestations and associated risks.',
        },
        {
            id: 4,
            name: 'Solar',
