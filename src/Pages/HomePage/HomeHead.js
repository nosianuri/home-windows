    ...
    return (
        <div className='bg-[#f6f6f6] '>
            <div className='mx-32'>
                ...
                <div className='my-1'>
                        <img src="https://i.ibb.co/TKMPp1p/fav-home.png" alt="" className='w-40' />
                    </div>
                    <div>
                        <img src="https://i.ibb.co/yFv6tCK/awards.png" alt="" className='24' />
                    </div>
                </div>
                    <div className='block'>
                        ...
                        <div className='flex text-[#198ec0] uppercase header-font text-[19px] font-bold '>
                            ...
                            <div className='px-4 py-3 hover:bg-[#fff]'>Why Choose Gudia <i class="fa-solid fa-angle-down pl-1"></i></div>
                            <div className='px-4 py-3 hover:bg-[#fff]'>Blog <i class="fa-solid fa-angle-down pl-1"></i></div>
                            <div className='px-4 py-3 hover:bg-[#fff]'>Contact Us <i class="fa-solid fa-angle-down pl-1"></i></div>
                        </div>
                    </div>
                </div>
            </div>
